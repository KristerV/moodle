...
require_once($CFG->dirroot.'/user/filters/anycourse.php');
...
class user_filtering {
    ...
    public function user_filtering($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            $fieldnames = array('realname' => 0, 'lastname' => 1, 'firstname' => 1, 'email' => 1, 'city' => 1,
                                ...
                                'username' => 1, 'auth' => 1, 'mnethostid' => 1);
        }
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'anycourses': return new user_filter_anycourses('anycourses', get_string('anycourses', 'filters'), $advanced, 'user_enrolments');
